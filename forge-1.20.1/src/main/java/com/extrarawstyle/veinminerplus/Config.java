...
public final class Config {
    ...
    public static final ForgeConfigSpec.IntValue BLAST_CHUNK_SCANS_PER_TICK = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> BLOCK_WHITELIST = BUILDER
